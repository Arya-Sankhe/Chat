...
- `0.1.0-beta.12` is the current unsigned private-beta release candidate. Its clean 201.7 MiB installer completed a tested beta upgrade in 25 seconds and now supports the payload's longest paths on stock Windows, down from 271.7 MiB and roughly 6.5 minutes. The public channel remains signing-gated.
