...
const SPECIALIZED_SKILLS = {
  ...
  "excel-create": [
    ...
    "- Plan the workbook before calling the tool: sheet names, each sheet's table headers, assumptions, calculated fields, and any summary sheet.",
    "- Prefer data.sheets, data.rows, tables, and clear headers over prose. Do not encode multiple unrelated tables into one sparse grid if separate sheets are better.",
