...
const SPECIALIZED_SKILLS = {
  ...
  "excel-create": [
    ...
    "- Plan the workbook first: each sheet's name, purpose, header row, calculated columns, which columns deserve charts and conditional formatting, and a summary/cover.",
    ...
    "- Add data.cover = {subtitle, metrics: [{label, value}], notes} only when a real summary/index page helps; it is never added implicitly.",
