-- Reserve only when settled usage plus all existing holds plus this request fit
-- the weekly allowance. The weekly row lock makes this check atomic across
-- concurrent web and desktop requests.
