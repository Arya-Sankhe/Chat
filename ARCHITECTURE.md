...
| Android Play-style universal link (`https://klui.ai/.well-known/assetlinks.json`) | Generated by `scripts/mobile/write-asset-links.mjs`; the legacy klui.tech host remains accepted by installed clients. |
