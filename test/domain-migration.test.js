...
test("klui.tech browser navigation is treated as legacy without intercepting APIs or Klui.ai", () => {
  ...
  assert.equal(isLegacyWebNavigation(request("klui.tech", "*/*"), new URL("https://klui.tech/")), true);
  assert.equal(isLegacyWebNavigation({ method: "GET", headers: { host: "klui.tech" } }, new URL("https://klui.tech/")), true);
  assert.equal(isLegacyWebNavigation({ method: "HEAD", headers: { host: "klui.tech" } }, new URL("https://klui.tech/c/123")), true);
  ...
  assert.equal(isLegacyWebNavigation(request("klui.tech"), new URL("https://klui.tech/downloads/android/latest.json")), false);
